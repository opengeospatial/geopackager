...
public abstract class AbstractWMTSHarvester extends AbstractHarvester {
	...
	private static final Logger LOG = Logger.getLogger(AbstractWMTSHarvester.class);
	...
	private TileServer wmts;
	private LayerInformation layerInfo;
	private Envelope clipRect;
	...
	protected void harvestTiles(GeoPackage gpkg, TileServer wmts, LayerInformation layerInfo, Envelope clipRect, Map<String, String> params) throws GeoPackageException {
		
		this.gpkg = gpkg;
		this.wmts = wmts;
		this.layerInfo = layerInfo;
		this.clipRect = translateCRS(clipRect, layerInfo.getCrs());
		this.params = params;
	...
	private static Envelope translateCRS(Envelope clipRect, String crs) throws GeoPackageException {
		if (clipRect == null) {
			return null;
		}
	...
	private class TileWriter {
		...
		public void write(TileFetcher fetcher) throws GeoPackageException {
			...
			++ tilesSaved;
			getProgressTracker().setProgress((int) (tilesSaved * 100.0 / tilesExpected + 0.5));
